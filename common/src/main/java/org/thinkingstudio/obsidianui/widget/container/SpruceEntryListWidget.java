...
public abstract class SpruceEntryListWidget<E extends SpruceEntryListWidget.Entry> extends AbstractSpruceParentWidget<E>
	...
	private Background background = TransparentBackground.DARKENED;
	...
	protected void renderWidget(DrawContext drawContext, int mouseX, int mouseY, float delta) {
		...
		if (maxScroll > 0) {
			...
			this.renderScrollbar(tessellator, tessellator.getBuffer(), scrollbarPositionX, scrollBarEnd, scrollbarY, scrollbarHeight);
		}
