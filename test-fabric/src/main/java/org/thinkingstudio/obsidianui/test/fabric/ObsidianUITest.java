...
public class ObsidianUITest implements ClientModInitializer {
	...
	public ObsidianUITest() {
		this.booleanOption = new SpruceBooleanOption("obsidianui_test.option.boolean",
				...
				true);
		this.checkboxOption = new SpruceCheckboxBooleanOption("obsidianui_test.option.checkbox",
				...
				true);
		this.toggleSwitchOption = new SpruceToggleBooleanOption("obsidianui_test.option.toggle_switch",
				() -> this.toggleBoolean,
		...
		this.separatorOption = new SpruceSeparatorOption("obsidianui_test.option.separator", true, null);

		this.doubleOption = new SpruceDoubleOption("obsidianui_test.option.double",
				0.0, 50.0, 1.f,
				() -> this.aDouble,
		...
		this.cyclingOption = new SpruceCyclingOption("obsidianui_test.option.cycling",
		...
		this.intInputOption = new SpruceIntegerInputOption("obsidianui_test.option.int_input",
				() -> this.anInt,
				value -> this.anInt = value,
				Text.literal("Represents an option with an integer value as text."));
		this.floatInputOption = new SpruceFloatInputOption("obsidianui_test.option.float_input",
				() -> this.aFloat,
				value -> this.aFloat = value,
				Text.literal("Represents an option with a float value as text."));
		this.doubleInputOption = new SpruceDoubleInputOption("obsidianui_test.option.double_input",
				() -> this.anInputDouble,
		...
		this.actionOption = SpruceSimpleActionOption.of("obsidianui_test.option.action",
				btn -> {
					MinecraftClient client = MinecraftClient.getInstance();
					SystemToast toast = SystemToast.create(client, SystemToast.Type.WORLD_ACCESS_FAILURE,
